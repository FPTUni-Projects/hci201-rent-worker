...
import './HCIDetail.dart';

class HCIDetail1 extends StatelessWidget {
  HCIDetail1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(33.6, 318.0),
            child: SizedBox(
              width: 317.0,
              child: Text(
                'Chưa có thợ trong khu vực của \nbạn, vui lòng chọn lại sau!',
                style: TextStyle(
                  fontFamily: 'Segoe UI',
                  fontSize: 19,
                  color: const Color(0xff000000),
            ...
            child: PageLink(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(width: 1.0, color: const Color(0xfff18c8e)),
                ),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(161.5, 387.0),
            child: SizedBox(
              width: 53.0,
              child: Text(
                'Đóng',
